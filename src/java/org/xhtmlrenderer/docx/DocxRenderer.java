...
//        File f = new File(System.getProperty("user.dir") + "/demos/browser/xhtml/hamlet-shortest.xhtml");
        ...
        System.out.println("layout commencing");
        renderer.layout();
        
        // Now I can walk the tree :-)
        
        StyleableTraverser st = new StyleableTraverser();
        st.traverse(renderer._root, "");
...
//        _outputDevice.setSharedContext(_sharedContext);
        ...
        // Need the font stuff; may as well just use ITextFontResolver
